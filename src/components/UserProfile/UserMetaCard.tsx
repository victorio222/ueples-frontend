...
// //       const response = await UserService.update(userData.user_id, dataPayload);
// //       if (response.data) {
...
// //     setLoading(true);
// //     try {
// //       await UserService.updatePassword(userData.user_id, {
...
// //                 <span
// //                   className={`mx-2 text-xs px-2 py-1 rounded-full font-medium ${userData?.status === "Active" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
// //                 >
// //                   {userData?.status}
// //                 </span>
// //               </h4>
...
//     // Using toast.promise for a better UX
//     toast.promise(
