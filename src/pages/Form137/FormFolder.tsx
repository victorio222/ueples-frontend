...
//         className="max-w-[450px] p-6 sm:p-8 z-99999"
//       >
...
export default function FormFolder() {
  ...
  const handleCreateFolder = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Success Alert
      await showAlert.success("Created!", `Academic Year ${newYear} is now available.`);
      ...
      // 3. Error Alert
      const msg = err.response?.data?.message || "Failed to create folder. Please try again.";
    ...
    <>
      ...
      >
        <div className="text-center">
          ...
          <p className="mb-6 text-sm text-gray-500">Enter the academic year to organize incoming documents.</p>
          <form onSubmit={handleCreateFolder} className="space-y-4">
            <div className="text-left">
              <Label>Academic Year</Label>
              <Input
